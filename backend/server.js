...
// --- 3. MIDDLEWARE ---
// UPDATED CORS for better mobile/live support
app.use(cors({
    origin: '*',
...
// FIXED: Changed localhost to process.env.MONGO_URI for Render
const mongoURI = process.env.MONGO_URI || 'mongodb://localhost:27017/uk_techub_db';
...
app.post('/api/send-email', async (req, res) => {
    ...
    const mailOptions = {
        from: `"UK TECHUB" <${process.env.EMAIL_USER}>`, 
        to: email,
...
app.listen(PORT, () => {
    console.log(`🚀 UKTECHUB SERVER IS LIVE`);
});